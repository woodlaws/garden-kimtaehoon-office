...
export default function ServicesPage() {
  ...
  return <>
    ...
    <section className="services-hero"><div className="shell services-hero-inner">
      <div className="services-hero-copy"><p className="eyebrow">ADMINISTRATIVE SERVICES</p><h1>복잡한 행정업무,<br/><strong>상황에 맞는 절차를 안내합니다.</strong></h1><p>인허가부터 기업행정·행정심판·출입국 업무까지<br/>현재 상황을 확인하고 필요한 절차와 준비사항을 안내해 드립니다.</p><div className="button-row"><a className="button gold" href="#service-finder">내 업무 분야 찾기</a><Link className="button outline-light" href="/consultation">상담 신청하기</Link></div></div>
    ...
    <section className="service-final-cta"><div className="shell service-final-cta-inner"><div><p className="eyebrow">CONSULTATION</p><h2>필요한 행정절차를 찾았다면,<br/><strong>현재 상황부터 확인해 보세요.</strong></h2><p>문의 내용을 남겨주시면 확인 후 상담 가능한 업무와 준비사항을 안내해 드립니다.</p></div><div className="service-final-actions"><Link className="button gold" href="/consultation">온라인 상담 신청</Link>{siteConfig.phoneHref ? <a className="button outline-light" href={siteConfig.phoneHref}><Phone/> 전화 상담</a> : <span className="button outline-light disabled" aria-disabled="true"><Phone/> 전화 상담</span>}<Link className="button outline-light" href="/about">김태훈 행정사 소개 보기</Link></div></div></section>
  </>;
}
