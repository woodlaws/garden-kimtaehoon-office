...
export default function AboutPage() {
  ...
  return <>
    ...
    <section className="about-final-cta"><div className="shell about-final-cta-inner"><div><p className="eyebrow">CONSULTATION</p><h2>어떤 절차가 필요한지 막막하다면,<br/><strong>현재 상황부터 함께 확인하겠습니다.</strong></h2><p>문의 내용을 남겨주시면 확인 후 상담 가능한 업무와 준비사항을 안내해 드립니다.</p></div><div className="about-final-actions"><Link className="button gold" href="/consultation">온라인 상담 신청</Link><Link className="button outline-light" href="/services">업무 분야 확인</Link>{siteConfig.phoneHref ? <a className="button outline-light" href={siteConfig.phoneHref}><Phone/> 전화 상담</a> : <span className="button outline-light disabled" aria-disabled="true"><Phone/> 전화 상담</span>}<Link className="about-location-link" href="/#location">오시는 길 안내 →</Link></div></div></section>
  </>;
}
