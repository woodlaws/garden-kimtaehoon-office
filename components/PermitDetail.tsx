...
export function PermitDetail() {
  ...
  return <>
    ...
    <section className="permit-hero"><div className="shell permit-hero-grid">
      <div className="permit-hero-copy"><p className="eyebrow">LICENSE & PERMIT</p><h1>사업 시작에 필요한 인허가,<br/><strong>신청보다 요건 확인이 먼저입니다.</strong></h1><p>업종과 사업장, 시설기준과 관할기관을 먼저 확인하고 허가·등록·신고에 필요한 절차와 자료를 안내합니다.</p><div className="button-row"><Link className="button gold" href="/consultation?service=licensing">인허가 업무 상담하기 <ArrowRight/></Link><a className="button outline-light" href="#permit-review">검토 항목 확인하기</a></div></div>
    ...
    <section className="permit-final"><div className="shell"><HelpCircle/><div><p className="eyebrow">CONSULTATION</p><h2>계약과 공사를 시작하기 전에,<br/><strong>사업에 필요한 인허가부터 확인하세요.</strong></h2><p>사업 내용과 예정 장소, 현재 진행 단계를 알려주시면 상담 가능한 업무와 우선 확인할 사항을 안내해 드립니다.</p></div><div className="button-row"><Link className="button gold" href="/consultation?service=licensing">인허가 업무 상담하기</Link><Link className="button outline-light" href="/services">전체 업무 분야 보기</Link></div></div></section>
  </>;
}
